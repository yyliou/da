...
Adding a scale with `+` actually **overrides** any existing scale for that aesthetic — the last one wins. Replacing a default scale happens silently; ggplot2 only shows a message when you explicitly add two scales for the same aesthetic:
