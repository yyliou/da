...
-   About the `mpg` dataset included with `ggplot2`, §2.2.

-   The three key components of every plot: data, aesthetics and geoms, §2.3.

-   How to add additional variables to a plot with aesthetics, §2.4.

-   How to display additional categorical variables in a plot using small multiples created by faceting, §2.5.

-   A variety of different geoms that you can use to create different types of plots, §2.6.

-   How to modify the axes, §2.7.

-   Things you can do with a plot object other than display it, like save it to disk, §2.8.
...
In the first plot, the value “blue” is scaled to a pinkish colour, and a legend is added. In the second plot, the points are given the R colour blue. This is an important technique and you’ll learn more about it in §13.4.2. See vignette("`ggplot2`-specs") for the values needed for colour and other aesthetics.
...
You might wonder when to use faceting and when to use aesthetics. You’ll learn more about the relative advantages and disadvantages of each in §16.5.
...
(You’ll learn how to fix the labels in §17.4.2).
...
-   Save it to disk with `ggsave()`, described in §17.5.
