...
- **§7.1** — the structure of network data and the `tidygraph` manipulation API.
- **§7.2** — visualising networks with `ggraph`: layouts, node geoms, edge geoms, and faceting.
- **§7.3** — pointers to further resources.
